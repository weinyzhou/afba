...
#define VOL_CAP 1.80
	...
	static const INT16 dpcm[16] = {
		...
		static_cast<INT16>(-64<<8), static_cast<INT16>(-49<<8), static_cast<INT16>(-36<<8), static_cast<INT16>(-25<<8), static_cast<INT16>(-16<<8), static_cast<INT16>(-9<<8), static_cast<INT16>(-4<<8), static_cast<INT16>(-1<<8)
	};
