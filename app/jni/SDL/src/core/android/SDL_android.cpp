...
// Resize
extern "C" void Java_fr_mydedibox_libarcade_emulator_sdl_SDLJni_onNativeResize(
...
// Keydown
extern "C" void Java_fr_mydedibox_libarcade_emulator_sdl_SDLJni_onNativeKeyDown(
...
// Keyup
extern "C" void Java_fr_mydedibox_libarcade_emulator_sdl_SDLJni_onNativeKeyUp(
                                    JNIEnv* env, jclass jcls, jint keycode)
{
...
// Touch
extern "C" void Java_fr_mydedibox_libarcade_emulator_sdl_SDLJni_onNativeTouch(
                                    JNIEnv* env, jclass jcls,
...
// Accelerometer
extern "C" void Java_fr_mydedibox_libarcade_emulator_sdl_SDLJni_onNativeAccel(
                                    JNIEnv* env, jclass jcls,
...
// Quit
extern "C" void Java_fr_mydedibox_libarcade_emulator_sdl_SDLJni_nativeQuit(
...
// Pause
extern "C" void Java_fr_mydedibox_libarcade_emulator_sdl_SDLJni_nativePause(
                                    JNIEnv* env, jclass cls)
{
    if (Android_Window) {
...
// Resume
extern "C" void Java_fr_mydedibox_libarcade_emulator_sdl_SDLJni_nativeResume(
                                    JNIEnv* env, jclass cls)
{
    if (Android_Window) {
...
extern "C" void Java_fr_mydedibox_libarcade_emulator_sdl_SDLJni_nativeRunAudioThread(
                                    JNIEnv* env, jclass cls)
{
